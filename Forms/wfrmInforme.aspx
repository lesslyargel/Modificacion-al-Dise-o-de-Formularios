<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmInforme.aspx.cs" Inherits="wfrmInforme" StyleSheetTheme="Modal" %>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" width="30%">
                                    <asp:TextBox ID="txtDescripcion" runat="server" BackColor="#99FFCC" 
                                        CssClass="texto10" MaxLength="50" Width="80%" Enabled="False" style='text-transform:uppercase'></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
